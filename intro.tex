...
The stucture of the report follows the same order as the work was done in the lab sessions.

As stated before, to simplify the system only one motor is controlled dynamically while the other, the master, is kept at a contstant velocity. Section \ref{} \todo{reference} describes the design a controller for this master.

After implementing a controller for the master, a controller was designed to control the speed of the slave motor. Section \ref{} \todo{reference} describes this process.

Being able to control both motors the behaviour of the traction was identified and a control law for the process could be devised. In section \ref{} \todo{reference} this is described. \todo{rewording of this paragraph maybe (no inspiration)}
